...
class Config:
    ...
    Attributes:
        ...
        TTS_MODEL (str): The model to use for text-to-speech ('openai', 'deepgram', 'elevenlabs', 'melotts', 'cartesia', 'kokoro-82M').
    ...
    TTS_MODEL = 'kokoro-82M'  # possible values: openai, deepgram, elevenlabs, melotts, cartesia, kokoro-82M
    ...
    def validate_config():
        ...
        Config._validate_model('TTS_MODEL', [
            'openai', 'deepgram', 'elevenlabs', 'melotts', 'cartesia', 'kokoro-82M', 'local'])
